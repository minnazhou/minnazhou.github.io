...
$('.b-y1920s').click(function(){
  $('.item').addClass('hide');
  $('.item').removeClass('show');

  $('.item.y1920s').addClass('show');
  $('.item.y1920s').removeClass('hide');
});

$('.b-y1930s').click(function(){
  $('.item').addClass('hide');
  $('.item').removeClass('show');

  $('.item.y1930s').addClass('show');
  $('.item.y1930s').removeClass('hide');
});
